 ...
 *      
 *      someControllerData.triangleOn = 1;   // Marks the triangle button as pressed
 *      someControllerData.squareOn = 0;     // Marks the square button as unpressed
 *      someControllerData.leftStickX = 90;  // Analog stick values can range from 0 - 255
 */
...
//----- Below here is the actual implementation of
  ...
  volatile int serialCheckInterval = .001;
